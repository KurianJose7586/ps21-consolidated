...
- **Architecture & Design:** See `CompleteProjectDoc.md`
- **API Endpoints:** See `API.md` in `brd Module/`
- **Module Usage:** See `README.md` in `brd Module/`
- **DOCX Templates:** See `DOCX_EXPORT_GUIDE.md`
